...
async def tb_hypercorex_dut(dut):
    ...
    # Extract data set
    assoc_mem_fp = get_dir() + "/../hemaia/trained_am/hypx_ucihar_am.txt"
    ...
    # Extract samples
    test_samples_fp = get_dir() + "/../hemaia/test_samples/hypx_ucihar_test.txt"
    ...
    print(len(test_samples_compressed[0]))
...
def test_hypercorex_ucihar_recog(simulator, parameters, waves):
    ...
    module = "test_hypercorex_ucihar_recog"
