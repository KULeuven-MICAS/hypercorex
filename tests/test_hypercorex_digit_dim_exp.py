...
NUM_FEATURES = 28 * 28
NUM_PREDICTIONS = 10
NUM_HV_EXPANSION = 1  # Number of times to expand the HV dimension
...
async def tb_hypercorex_dut(dut):
    ...
    # Extract data set
    assoc_mem_fp = get_dir() + "/../hemaia/trained_am/hypx_digit_am_multi.txt"
    ...
    # Extract samples
    test_samples_fp = get_dir() + "/../hemaia/test_samples/hypx_digit_nsample_test.txt"
    ...
    # read_loop_count2 = await read_csr(dut, set_parameters.INST_LOOP_COUNT2_REG_ADDR)
    # check_result(loop_count2, read_loop_count2)
    ...
    [
        {
            ...
            "TbMemDepthLowDimA": str(NUM_FEATURES * NUM_HV_EXPANSION),
            "TbAMMemDepth": str(NUM_CLASSES * NUM_HV_EXPANSION),
        }
    ],
)
def test_hypercorex_digit_dim_exp(simulator, parameters, waves):
    ...
    module = "test_hypercorex_digit_dim_exp"
