"""
  ...
  Description:
  This tests the DNA recognition application
"""
...
# Some parameters about the dna recognition set
NUM_CLASSES = 3
NUM_FEATURES = 60
NUM_PREDICTIONS = 10
NUM_HV_EXPANSION = 2
...
async def tb_hypercorex_dut(dut):
    cocotb.log.info(" ------------------------------------------ ")
    cocotb.log.info("         Testing dna Recognition          ")
    cocotb.log.info(" ------------------------------------------ ")

    # Extract data set
    assoc_mem_fp = get_dir() + "/../hemaia/trained_am/hypx_dna_am_multi.txt"
    ...
    # Extract samples
    test_samples_fp = get_dir() + "/../hemaia/test_samples/hypx_dna_nsample_test.txt"
    ...
    # Compress 4-bit data into a 64-bit data
    ...
    # Extract asm file
    inst_file_path = get_dir() + "/../sw/asm/test_dna_recog.asm"
...
def test_hypercorex_dna_dim_exp(simulator, parameters, waves):
    ...
    module = "test_hypercorex_dna_dim_exp"
