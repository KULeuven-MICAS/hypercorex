...
async def tb_hypercorex_dut(dut):
    ...
    # Extract data set
    assoc_mem_fp = get_dir() + "/../hemaia/trained_am/hypx_lang_am.txt"
    ...
    # Extract samples
    test_samples_fp = get_dir() + "/../hemaia/test_samples/hypx_lang_test.txt"
    ...
    # Load list to A
    test_sub_samples = test_samples[:NUM_PREDICTIONS]
...
def test_hypercorex_lang_recog(simulator, parameters, waves):
    ...
    module = "test_hypercorex_lang_recog"
