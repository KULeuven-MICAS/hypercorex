...
async def tb_hypercorex_dut(dut):
    ...
    for i in range(len(test_samples)):
        test_samples[i] = test_samples[i][0:NUM_FEATURES]
...
def test_hypercorex_isolet_recog_generic(simulator, parameters, waves):
    ...
    module = "test_hypercorex_isolet_recog_generic"
