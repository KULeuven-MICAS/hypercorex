...
async def tb_hypercorex_dut(dut):
    ...
    # Extract data set
    assoc_mem_fp = get_dir() + "/../hemaia/trained_am/hypx_isolet_am.txt"
    ...
    # Extract samples
    test_samples_fp = get_dir() + "/../hemaia/test_samples/hypx_isolet_test.txt"
    ...
    # Extract asm file
    inst_file_path = get_dir() + "/../sw/asm/train_isolet_recog.asm"
...
def test_hypercorex_isolet_recog(simulator, parameters, waves):
    ...
    module = "test_hypercorex_isolet_recog"
