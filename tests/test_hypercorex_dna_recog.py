...
async def tb_hypercorex_dut(dut):
    ...
    # Extract data set
    assoc_mem_fp = get_dir() + "/../hemaia/trained_am/hypx_dna_am.txt"
    ...
    # Extract samples
    test_samples_fp = get_dir() + "/../hemaia/test_samples/hypx_dna_test.txt"
...
def test_hypercorex_dna_recog(simulator, parameters, waves):
    ...
    module = "test_hypercorex_dna_recog"
