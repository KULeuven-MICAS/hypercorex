...
INST_LOOP_COUNT1_REG_ADDR = 12
INST_LOOP_COUNT2_REG_ADDR = 13

# Data slice configurations
DATA_SRC_CTRL_REG_ADDR = 14
DATA_SLICE_NUM_ELEM_A_REG_ADDR = 15
DATA_SLICE_NUM_ELEM_B_REG_ADDR = 16
DATA_SRC_AUTO_START_A_REG_ADDR = 17
DATA_SRC_AUTO_START_B_REG_ADDR = 18
DATA_SRC_AUTO_NUM_A_REG_ADDR = 19
DATA_SRC_AUTO_NUM_B_REG_ADDR = 20

# Observable register
OBSERVABLE_REG_DATA = 21
